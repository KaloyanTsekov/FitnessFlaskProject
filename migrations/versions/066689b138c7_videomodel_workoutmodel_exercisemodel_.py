...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=35), nullable=False),
    sa.Column('category', sa.Enum('legs', 'arms', 'shoulders', 'chest', 'back', 'abs', name='bodysection'), nullable=False),
    sa.Column('youtube_link', sa.String(length=255), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('workout_model',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=35), nullable=False),
    sa.Column('category', sa.Enum('legs', 'arms', 'shoulders', 'chest', 'back', 'abs', name='bodysection'), nullable=False),
    sa.Column('day', sa.Enum('monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday', name='daysfromtheweekend'), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
