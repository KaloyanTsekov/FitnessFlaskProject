...
def upgrade():
    ...
    op.add_column('admin_user', sa.Column('photo_url', sa.String(length=255), nullable=True))
    op.add_column('moderator_user', sa.Column('photo_url', sa.String(length=255), nullable=True))
    op.add_column('regular_user', sa.Column('photo_url', sa.String(length=255), nullable=True))
